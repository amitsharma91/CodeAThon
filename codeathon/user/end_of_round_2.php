						...
						<div class="col-md-6">
							<div class="business_item sm-m-top-50">
								<h2 class="text-uppercase">
									<strong style="font-family: arial;">End Round-2</strong> Test
								</h2>
								<h5>click <a href='round_3_timer_init.php' style='text-decoration: underline;'>here</a> to proceed to <b style='color: #009688;font-family: arial;'>Round-3</b></h5>
							</div>
						</div>
					</div>
				</div>
