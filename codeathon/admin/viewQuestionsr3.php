<?php 
	...
	$query = "SELECT * FROM question WHERE round_type=3";
...
<?php  
   			header("Refresh:0; url=viewQuestionsr3.php");
   		}
   	}
?>
      ...
      <table class="table table-bordered">
        ...
        ?>		
        		<tr>
		            ...
		            <td><a href="viewQuestionsr3.php?delete=<?php echo $row['id']?>"  onclick="return confirm('Are you sure you want to delete?')"><img src="images/delete.png" alt="" width="18px" height="18px"/></a></td>
	          	</tr>
        <?php 		
        	}
        ?>
